...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(1147914, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Saturated Eating"
...
modrinth {
    ...
    projectId.set("saturated-eating")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Saturated Eating")
    dependencies {
